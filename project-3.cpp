...
int main()
{
    ...
    Student *students[5]=
    {
        new Student("Razib Ahmed","18-11-1995",10708041,department),
        new Student("KM RAZ","04-12-1996",10708013,department),
        new Student("Alif Ahmed","10-02-1995",10508010,department),
        new Student("Saiful Islam","18-10-1996",10708041,department),
        new Student("Rajon Khan","06-10-1995",10708013,department)
    };
    Teacher *teachers[6]=
    {
    ...
    cout<<"*_*_*_*_*_*_*        Students Who Voted In The Survey       *_*_*_*_*_*"<<endl<<endl;
    for(int i=0; i<5; i++)
    {
    ...
    cout<<"*_*_*_*_*       Teachers Who Voted In The Survey        *_*_*_*_*"<<endl<<endl;
    ...
    cout<<"*_*_*_*_*       Final Result Of the Survey           *_*_*_*_*"<<endl<<endl;
    for(int i=0; i<5; i++)
    {
        int sum=0;
        for(int j=0; j<5; j++)
