...
public:
    ...
    void viewPerson()
    {
        ...
        cout<<"Birthday : "<<this->dateOfBirth<<endl;
    }
...
public:
    ...
    int totalsolve,id;
    Student() {};
    Student(string name,string dateOfBirth,Department department,int id,int totalsolve,string typeOfCoder) : Person(name,dateOfBirth)
    {
        this->id=id;
    ...
    void view_student_info()
    {
        ...
        cout<<"Students Birthday: "<<this->dateOfBirth<<endl;
...
public:
    ...
    Department department;
    Faculty() {};
    Faculty(string designation,string name,string dateOfBirth, Department department):Person(name,dateOfBirth)
    {
